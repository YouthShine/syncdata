...
public class Commodity {
	public Commodity(Integer commodity_id, String commodity_name,
			String na_commodity_name, List<CommodityAttr> commodity_attr,
			...
			Integer brand_id, String brand_name, String na_brand_name,
			String brand_name_cn, String brand_name_en, String logo_url,
			Boolean is_display, Integer platform_id, String platform_name,
			String platform_url, String payment_cycle, String payment_method,
			Boolean is_recommend, Integer sales_volume, Double credit,
			String area) {
		super();
		this.commodity_id = commodity_id;
		this.commodity_name = commodity_name;
		this.na_commodity_name = na_commodity_name;
		...
		this.na_brand_name = na_brand_name;
	...
	private String na_commodity_name;
	...
	public String getNa_commodity_name() {
		return na_commodity_name;
	}

	public void setNa_commodity_name(String na_commodity_name) {
		this.na_commodity_name = na_commodity_name;
	}
	...
	public String getNa_brand_name() {
		return na_brand_name;
	}

	public void setNa_brand_name(String na_brand_name) {
		this.na_brand_name = na_brand_name;
	}
