...
public class CommodityValue {
	...
	public CommodityValue(Integer commodity_id, String commodity_name,
			 List<CommodityAttr> commodity_attr,
			 List <DetailsAttr> details,
			 List <PackAttr> pack,
			 List <IntroAttr> intro,
			 List <SpeciAttr> speci,
	...
	private List<DetailsAttr> details;
	private List <PackAttr> pack;
	private List <IntroAttr> intro;
	private List <SpeciAttr> speci;
	...
	public List<DetailsAttr> getDetails() {
		return details;
	}

	public void setDetails(List<DetailsAttr> details) {
		this.details = details;
	}
	
	public List <IntroAttr> getIntro() {
		return intro;
	}

	public void setIntro(List<IntroAttr> intro) {
		this.intro = intro;
	}
	
	public List <PackAttr> getPack() {
		return pack;
	}

	public void setPack(List<PackAttr> pack) {
		this.pack = pack;
	}
	
	public List <SpeciAttr> getSpeci() {
		return speci;
	}

	public void setSpeci(List<SpeciAttr> speci) {
		this.speci = speci;
	}
